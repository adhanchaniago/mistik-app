...
<section id="home">
    ...
    <a class="btn tombol1" href="/login.html">Donasi Sekarang</a>
    <a class="btn tombol1" href="/daftar_relawan.html">JadiRelawan</a>
		</div>
	</div>
</section>
<!-- End Jumbotron -->
		...
		<div class="row">
			<div class="col-lg-3">
				<div class="card" style="width: 16rem;">
					<img class="card-img-top" src="<?= base_url(); ?>asset/img/content/lombok-01.png" alt="Card image cap">
					<div class="card-body">
			...
			<div class="col-lg-3">
				<div class="card" style="width: 16rem;">
					<img class="card-img-top" src="<?= base_url(); ?>asset/img/content/sumatra-01.png" alt="Card image cap">
					<div class="card-body">
			...
			<div class="col-lg-3">
				<div class="card" style="width: 16rem;">
					<img class="card-img-top" src="<?= base_url(); ?>asset/img/content/palu-01.png" alt="Card image cap">
					<div class="card-body">
						<h5 class="card-title">Peduli Palu</h5>
						<p class="card-text">Some quick example text to build on the card title and make up the bulk of the
							card's content.</p>
						<a href="#" class="btn card-button">Donasi Sekarang</a>
					</div>
			...
			<div class="col-lg-3">
				<div class="card" style="width: 16rem;">
					<img class="card-img-top" src="<?= base_url(); ?>asset/img/content/sinabung-01.png" alt="Card image cap">
					<div class="card-body">
		...
		<div class="row">
			<div class="col">
				...
				<p>Kesulitan dalam melakukan donasi? Kami siap melayani anda 24 Jam.<br> Hubungi kami melalui cara berikut
					...
					:</p>
				<div class="d-flex justify-content-center">
					<button class="btn cs"><i class="fas fa-phone"></i> Customer Service</button> <button class="btn email"><i class="fas fa-at"
					style="font-size:18px; color: white;"></i></i> Email</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row py-4 d-flex align-items-center">
				...
				<div class="col-md-6 col-lg-7 text-center text-md-right">
					<!-- Facebook -->
					<a href="" class="fb-ic" style="color: white; font-size:30px;">
						<i class="fab fa-facebook-f white mr-4"> </i>
					</a>
					<!-- Twitter -->
					<a href="" class="tw-ic" style="font-size:30px; color: white;">
						<i class="fab fa-twitter white-text mr-4"> </i>
					</a>
					<!-- Google +-->
					<a href="" class="gplus-ic" style="color: white; font-size:30px;">
						<i class="fab fa-google-plus-g mr-4"> </i>
					</a>
					<!--Instagram-->
					<a href="" class="ins-ic" style="color: white; font-size:30px;">
	...
	<div class="container text-center text-md-left mt-5">
		...
		<div class="row mt-3">
			...
			<div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
				...
				<p>
					<a href="#!">Bantu rakyat Sinabung</a>
				</p>
			</div>
			<!-- Grid column -->
			<!-- Grid column -->
